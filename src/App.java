...
System.out.println("Descrizione prodotto: " + prodotto1.getDescrizone());
System.out.println("Prezzo base del prodotto: € " + prodotto1.getPrezzo());//String format: %.2f = solo 2 decimali
